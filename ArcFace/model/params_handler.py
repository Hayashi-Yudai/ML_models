...
def parse_args():
    ...
    parser.add_argument('--train_data', default='/home/yudai/Pictures/raw-img/train', type=str)
    parser.add_argument('--validation_data', default='/home/yudai/Pictures/raw-img/validation', type=str)
    parser.add_argument('--param_folder', default='', type=str)
...
def save_info(dir_name, args, model):
	with open(f"{dir_name}/info.txt", "w") as f:
		...
		f.write(f"used parameters: {args.param_folder}\n")
